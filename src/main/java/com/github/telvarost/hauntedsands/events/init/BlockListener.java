...
public class BlockListener {
    ...
    public void registerBlocks(BlockRegistryEvent event) {
        ...
        GRAVE             = new Grave          (Identifier.of(HauntedSands.HAUNTED_SANDS, "grave")            , Material.STONE)                        .setHardness(1.0F).setResistance(20.0F).setSoundGroup(STONE_SOUND_GROUP).setTranslationKey(HauntedSands.HAUNTED_SANDS, "grave");
